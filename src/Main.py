...
# EXAMPLE TEST============================================================================
test_data = data[data['PubChem Compound CID'] == 44558536]
...
# Create a DataFrame and sort it based on feature importance
...
# Optional: Print top N features
top_n = 120
print("\nTop 120 Important Features:")
