...
model = Sequential([ 
    Dense(2048, activation='relu', input_shape=(X_train.shape[1],)),        # (Rectified Linear Unit)
    Dropout(0.3), 
    Dense(1024, activation='relu'),                                         
    Dropout(0.3),   
    Dense(512, activation='relu'),                                          #, kernel_regularizer=l2(0.001)       # L2 REGULIZER
...
model.fit(X_train, y_train, epochs=120, batch_size=232, validation_split = 0.23, callbacks=[early_stopping])          
