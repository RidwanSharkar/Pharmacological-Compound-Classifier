...
'MQN1', 'MQN2', 'MQN3', 'MQN4', 'MQN5', 'MQN6', 'MQN7', 
'MQN8', 'MQN9', 'MQN10', 'MQN11', 'MQN12', 'MQN13', 'MQN14', 
'MQN15', 'MQN16', 'MQN17', 'MQN18', 'MQN19', 'MQN20', 'MQN21', 
'MQN22', 'MQN23', 'MQN24', 'MQN25', 'MQN26', 'MQN27', 'MQN28', 
'MQN29', 'MQN30', 'MQN31', 'MQN32', 'MQN33', 'MQN34', 'MQN35', 
'MQN36', 'MQN37', 'MQN38', 'MQN39', 'MQN40', 'MQN41', 'MQN42'
]].fillna(0)
...
model = Sequential([
    Dense(512, activation='relu', input_shape=(X_train.shape[1],)), #, kernel_regularizer=l2(0.001)     # L2 REGULIZER
    #BatchNormalization(),                                           
    Dropout(0.3),   
...
adam_optimizer = Adam(learning_rate=0.001, clipnorm=1.0)                                                # GRADIENT CLIPPING
...
# explainer = shap.DeepExplainer(model, X_train[:100])  # Use a background dataset
# try:
